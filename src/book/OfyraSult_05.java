 ...
 * födelsedag och i såfall visa en dialogruta med texten Grattis!
 *
 */
public class OfyraSult_05 {
    public static void main(String[] arg){
        // variabler
        String
                iPersonnummer,
                title = "Är din födelsegdag?",
                fDag,
                sDatum;
        // Get datum
        ...
        // metod
        fDag = iPersonnummer.substring(2, 6);
        System.out.print(fDag);
        if(datum = fDag){
